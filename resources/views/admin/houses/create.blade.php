            ...
            <div class="card card-custom">
                <div class="card-header">
                    ...
                    <div class="card-toolbar">
                        <!--begin::Button-->
                        <a href="{{ aurl('houses/create') }}" class="btn btn-primary font-weight-bolder">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{aurl('houses')}}" enctype="multipart/form-data"
...
@push('css')
    <link href="{{url('admin/general')}}/css/dropzone.css" rel="stylesheet" type="text/css"/>
