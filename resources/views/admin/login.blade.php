...
<div class="d-flex flex-column flex-root">
    ...
    <div class="login login-5 login-signin-on d-flex flex-row-fluid" id="kt_login">
        <div class="d-flex flex-center bgi-size-cover bgi-no-repeat flex-row-fluid"
             style="background-image: url({{ url('admin') }}/assets/media/bg/bg-2.jpg);">
            <div class="login-form text-center text-white p-7 position-relative overflow-hidden">
                <!--begin::Login Header-->
                <div class="d-flex flex-center mb-15">
                    <a href="#">
{{--                        <img src="" class="max-h-120px" alt=""/>--}}
                    </a>
                </div>
                <!--end::Login Header-->
                ...
                <div class="login-signin">
                    <div class="mb-20">
                        <h3 class="opacity-40 font-weight-normal">@lang('Login To Admin')</h3>
                    </div>
                    @if (session('status'))
                    ...
                    <form method="POST" action="{{ route('login') }}" class="form" id="kt_login_signin_form">
                        ...
                        <div class="form-group">
                            <input class="form-control h-auto text-white bg-white-o-5 rounded-pill border-0 py-4 px-8"
                                   type="text" placeholder="@lang('email')" name="email" autocomplete="off"/>
                        </div>
...
{{--                               class="text-white font-weight-bold">@lang('Forget Password ?')</a>--}}
                        </div>
                        <div class="form-group text-center mt-10">
                            <button id="kt_login_signin_submit"
                                    class="btn btn-pill btn-primary opacity-90 px-15 py-3">@lang('Sign In')</button>
                        </div>
                ...
                <div class="login-forgot">
                    <div class="mb-20">
                        <h3 class="opacity-40 font-weight-normal">@lang('Forget Password ?')</h3>
                    ...
                    <form class="form" id="kt_login_forgot_form" method="POST" action="{{ route('password.email') }}">
                        <div class="form-group mb-10">
                            @csrf
                            <input class="form-control h-auto text-white bg-white-o-5 rounded-pill border-0 py-4 px-8"
                                   type="text" placeholder="@lang('admin.email')" name="email"  required autocomplete="email" autofocus/>
                        </div>
                        @error('email')
                        ...
                        <div class="form-group">
                            <button id="kt_login_forgot_submit"
                                    class="btn btn-pill btn-primary opacity-90 px-15 py-3">@lang('Send')</button>
                            <button id="kt_login_forgot_cancel"
                                    class="btn btn-pill btn-outline-white opacity-70 px-15 py-3 m-2">@lang('admin.Cancel')
                            </button>
                        </div>
                    </form>
                </div>
